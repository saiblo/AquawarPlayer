Shader "Underwater/Transparent/Standard"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf CustomStandard fullforwardshadows nofog finalcolor:applyfog alpha:fade
		...
		void applyfog(Input IN, SurfaceOutputStandardCustom o, inout fixed4 color)
		{
			...
			color.rgb = ( ( color.rgb * ( 1 - mixed) ) + ( fogColor * mixed) );// * color.a;
		}
