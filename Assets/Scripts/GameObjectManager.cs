...
public class GameObjectManager
{
    ...
    private readonly Func<Transform, Transform, Transform> _instantiate;
    ...
    {
        var fishTransform = _instantiate(
    ...
    public GameObjectManager(GameStates gameStates, Func<Transform, Transform, Transform> instantiate)
    {
